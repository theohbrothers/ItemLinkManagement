...
$MODULE_NAME = (Get-Item "$PSScriptRoot/../src/*" | Select-Object -First 1).Name
$MODULE_DIR = (Get-Item "$PSScriptRoot/../src/*" | Select-Object -First 1).FullName
...
Get-Module Pester | Remove-Module -Force # Remove existing imported Pester module
